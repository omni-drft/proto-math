...
EXPORT_SYMBOL void pmVec4Print(const struct pmVector4* v, enum pmEnum mode)
{
	if (mode == pmCompact)
...
EXPORT_SYMBOL float pmVec4Angle(const struct pmVector4* v1, const struct pmVector4* v2, enum pmEnum mode)
{
